...
const Register = () => {
	...
	return (
		<div>
			...
			<div className="text-gray-600 max-w-screen-1.5xl ml-auto max-h-70 pl-4 flex justify-between items-center overflow-hidden relative">
				<div className="font-semibold text-lg">
					<h1
						data-aos="fade-up"
						className="text-3xl font-extrabold pb-5 text-center"
					>
						Create an Account
					</h1>
					<form>
						...
						>
							...
							<input
								...
								name="name"
								id="name"
								className="outline-none rounded-full border px-3 py-2 focus:border-light-blue transition duration-500 ease-in-out"
								required
								autoComplete="off"
								value={customer.name}
								onChange={(e) =>
						...
						>
							...
							<input
								...
								id="email"
								autoComplete="off"
								className="outline-none rounded-full border px-3 py-2 focus:border-light-blue focus:border-2 transition duration-500 ease-in-out"
								required
						...
						<button
							className="bg-light-blue text-white py-3 px-8 rounded-full "
